...
<div class="container">
	<div class="row">
		<div class="headline"><p class="headline_title"><?php echo lang('headline_all_users_alert');?></p></div>
		<div class="alert alert-info must_login_note"><?php echo lang('view_all_users_alert');?></div>
	</div>
</div>
