...
/*
- Name:  Cisociall Lang - English
- Description:  English language file for Cisociall
*/
...
$lang['profile_map_cisociall']			= 'Cisociall Map';
...
$lang['profile_gl_exp']					='This <a href="http://www.geoplugin.com/" target="_blank" title="geoPlugin for IP geolocation">GeoPlugin</a> includes GeoLite data created by MaxMind, available from <a href="http://www.maxmind.com" target="_blank">http://www.maxmind.com</a>';
...
/* ||||||||||||||||||||| LOGIN PAGE ||||||||||||||||||||| */
$lang['headline_cisociall_login']		= 'Cisociall Login';
$lang['view_login_explanation']			= 'Cisociall is the best solution for user authentication with Social Network Accounts. It is built with <a href="http://www.codeigniter.com/" target="_blank"><b>CodeIgniter 3.1.5</b></a> and <a href="https://github.com/hybridauth/hybridauth/releases" target="_blank"><b>HybridAuth 2.9.5</b></a> If you have previously authenticated, you cant login with another social account at the same session. When login completed, system, automatically save user datas into the database. User datas can be different for Social Network Providers api policies!';

/* ||||||||||||||||||||| LOGGED IN PAGE ||||||||||||||||||||| */
$lang['headline_you_are_loggedin']		= 'You Are Logged In';
$lang['view_loggedin_alert']			= 'You have been successfully logged in! For login with another social account, you must logout this account!</a>';
...
$lang['view_all_users_alert']			= 'You must login for read this page content !';

/* ||||||||||||||||||||| CREDITS PAGE ||||||||||||||||||||| */
$lang['headline_credits']				= 'Credits';
...
$lang['title_top_5_lists']				= 'Top 5 Lists';
$lang['title_top_5_platforms']			= 'Top 5 Platforms';
$lang['title_top_5_browsers']			= 'Top 5 Browsers';
$lang['title_top_5_providers']			= 'Top 5 Providers';
$lang['title_not_mobiles']				= 'Not Mobile';
$lang['title_top_5_mobiles']			= 'Top 5 Mobiles';
$lang['title_server_details']			= 'Server Details';
$lang['title_total_disk_space']			= 'Total Disk Space';
$lang['title_free_disk_space']			= 'Free Disk Space';
$lang['title_used_disk_space']			= 'Used Disk Space';
$lang['title_free_disk_percent']		= 'Free Disk Percent';
$lang['title_used_disk_percent']		= 'Used Disk Percent';
$lang['title_memory_peak_usage']		= 'Memory Peak Usage';
$lang['title_memory_usage']				= 'Memory Usage';
$lang['title_memory_usage_percent']		= 'Memory Usage Percent';

/* ||||||||||||||||||||| FOOTER ||||||||||||||||||||| */
/* ------------------ Main Menu ------------------ */
$lang['footer_all_rights_reserved']		= 'All Rights Reserved by';
$lang['footer_site_owner']				= '<a href="https://codecanyon.net/user/okginteractive" target="_blank">o.k.g</a>';
$lang['footer_credits']					= '<a href="http://localhost/cisociall/credits">Credits</a>';